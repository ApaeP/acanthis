...
nb_de_tours.times do
  ...
  antique2.category = Category.find_by_title(["Achat/Vente", "Archéologie", "Salon Dij'Antik 2017", "Art Africain", "Art Asiatique"].sample)
  ...
  antique3.category = Category.find_by_title(["Achat/Vente", "Archéologie", "Salon Dij'Antik 2017", "Art Africain", "Art Asiatique"].sample)
  ...
  antique4.category = Category.find_by_title(["Achat/Vente", "Archéologie", "Salon Dij'Antik 2017", "Art Africain", "Art Asiatique"].sample)
  ...
  antique5.category = Category.find_by_title(["Achat/Vente", "Archéologie", "Salon Dij'Antik 2017", "Art Africain", "Art Asiatique"].sample)
  ...
  antique6.category = Category.find_by_title(["Achat/Vente", "Archéologie", "Salon Dij'Antik 2017", "Art Africain", "Art Asiatique"].sample)
  ...
  antique7.category = Category.find_by_title(["Achat/Vente", "Archéologie", "Salon Dij'Antik 2017", "Art Africain", "Art Asiatique"].sample)
  ...
  antique8.category = Category.find_by_title(["Achat/Vente", "Archéologie", "Salon Dij'Antik 2017", "Art Africain", "Art Asiatique"].sample)
